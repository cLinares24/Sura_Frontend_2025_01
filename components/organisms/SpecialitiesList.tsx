...
export default function SpecialitiesList() {
  ...
  return (
    <div className="mx-auto p-6 bg-[#e1ffed] rounded-2xl shadow-lg w-full min-h-screen ">
      <h1 className="text-2xl font-bold text-[#9155A7] mb-6 text-center mt-15">
        Especialidades Médicas
      </h1>
      <div className="max-w-[60%] mx-auto p-6 rounded-2xl shadow-lg">

  ...
  return (
    ...
    <div className="flex flex-mx full-width">
      ...
      <div className="bg-[#0133a1] text-white p-20 flex flex-col justify-center max-h-[800px] md:w-[43%] w-full relative z-10 ">
        <div className="border-t-2 border-[#00aec7] ml-[20%] max-w-[60px]"></div>
        <h2 className="text-4xl font-bold  mb-4 text-left max-w-[230px] ml-[20%] mt-2">
          Conoce la plataforma educativa de EPS SURA
        </h2>
        <p className="font-bold text-sm mb-6 ml-[18%] text-center max-w-[300px] mt-3">

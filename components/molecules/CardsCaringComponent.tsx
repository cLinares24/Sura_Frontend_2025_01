...
export default function CardHealth({ icon, title, text, link }: CardHealthProps) {
  return (
    <div className="flex flex-col gap-5 items-center text-[#0db26b] hover:shadow-lg border-1 hover:h-[103%] hover:-translate-y-1 transition-shadow duration-300 rounded-2xl p-6 cursor-pointer">
      ...
      <a
        href="#"
        className="text-[#0db26b] hover:underline text-sm font-medium"
      >
        &gt; {link}
      </a>
    </div>
